...
export const nikeModelsState: NikeModelType[] = [
  {
    id: 111,
  ...
  {
    id: 222,
    model: 'NIKE ZOOM FREAK 1',
    collection: 'Basketball Essentials',
    price: '$140.00',
    picture: nikeModel2,
  },
  {
  ...
  return (
    <div>
      ...
      <div style={{display: 'flex', justifyContent: 'center', gap: '20px'}}>
        {nikeModelsState.map(model => (
            <Link key={model.id} to={`/nike/${model.id}`}>
              <img
                src={model.picture}
                alt={model.model}
